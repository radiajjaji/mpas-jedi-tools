...
#SBATCH --exclusive
#SBATCH --export=NONE
#SBATCH --output=/scratch/lus/arw/jedi/mpas_only/3.0.3/30km/logs/bumploc.out
#SBATCH --error=/scratch/lus/arw/jedi/mpas_only/3.0.3/30km/logs/bumploc.out

set -x

#===============================================================================
# MPAS-JEDI 3.0.3
# 30-km BUMP/NICAS localization calibration
#
# Target mesh:
#   x1.655362
#
...
#
# Background:
#   Permanent 30-km calibration state under $ROOT/input.
#
# Output:
#   $HOME/jedi/mpas_only/3.0.3/30km/BUMPLOC
#===============================================================================
...
INVARIANT="$MPAS_MESH_DIR/x1.655362.invariant.nc"

GRAPH_PREFIX="$MPAS_MESH_DIR/x1.655362.graph.info.part."
...
#-------------------------------------------------------------------------------
# 5. Permanent 30-km calibration background
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
# 6. Validate 30-km calibration geometry
#-------------------------------------------------------------------------------
...
log "============================================================"
log "DONE: 30-km BUMPLOC calibration completed successfully"
