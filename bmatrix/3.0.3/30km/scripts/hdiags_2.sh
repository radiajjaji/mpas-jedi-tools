#!/bin/bash
#SBATCH --job-name=hdiags2_intel303_30km
...
#SBATCH --output=/scratch/lus/arw/jedi/mpas_only/3.0.3/30km/logs/hdiags_2.%j.out
#SBATCH --error=/scratch/lus/arw/jedi/mpas_only/3.0.3/30km/logs/hdiags_2.%j.err
...
main()
{
    ...
    #===========================================================================
    # Validate complete remapped 30 km background
    #===========================================================================
    ...
    log "============================================================"
    log "30 km HDIAGS vargroup2 configuration"
    log "============================================================"
    log "Root                    : ${ROOT}"
    ...
    #===========================================================================
    # MPAS geometry namelist for 30 km
    #===========================================================================
