#!/bin/bash
#
# MPAS-JEDI 4.0.0 GNU NICAS generation for remapped 30-km B matrix.
#
# Usage:
#
#   sbatch nicas.sh
#
# This is the fixed 30-km version.
...
log "============================================================"
log "Starting complete 30-km GNU400 NICAS generation"
...
log ""
log "============================================================"
log "ALL 30-km NICAS VARIABLES COMPLETED SUCCESSFULLY"
log "============================================================"
log "Output root: ${HOME}/jedi/mpas_only/3.0.3/30km/NICAS"
log "============================================================"
