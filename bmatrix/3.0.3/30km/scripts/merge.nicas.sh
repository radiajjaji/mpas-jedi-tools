...
nicasDir=/scratch/lus/arw/jedi/mpas_only/3.0.3/30km/NICAS
...
mkdir -p ${workdir}
mkdir -p /scratch/lus/arw/jedi/mpas_only/3.0.3/30km/logs
...
#!/bin/bash
#SBATCH --job-name=NICASmerge30
#SBATCH --partition=opr
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=128
#SBATCH --time=00:15:00
#SBATCH --output=/scratch/lus/arw/jedi/mpas_only/3.0.3/30km/logs/NICASmerge.%j.out
#SBATCH --error=/scratch/lus/arw/jedi/mpas_only/3.0.3/30km/logs/NICASmerge.%j.err

SECONDS=0

cd /scratch/lus/arw/jedi/mpas_only/3.0.3/30km/NICAS/merge || {
...
echo "============================================================"
echo "Starting 30-km NICAS merge"
...
echo
echo "============================================================"
echo "SUCCESS: 30-km NICAS merge completed"
