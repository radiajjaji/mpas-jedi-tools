#!/bin/bash
#SBATCH --job-name=hdiags1_intel303_30km
...
#SBATCH --output=/scratch/lus/arw/jedi/mpas_only/3.0.3/30km/logs/hdiags_1.%j.out
#SBATCH --error=/scratch/lus/arw/jedi/mpas_only/3.0.3/30km/logs/hdiags_1.%j.err
...
main()
{
    ...
    if [[ "${ROOT}" != "/scratch/lus/arw/jedi/mpas_only/3.0.3/30km" ]]; then
    ...
    #===========================================================================
    # Validate complete 30 km background/templateFields file
    #===========================================================================
    ...
    log "============================================================"
    log "30 km HDIAGS vargroup1 configuration"
    log "============================================================"
    log "Root                    : ${ROOT}"
...
PY_STREAM
    ...
    #===========================================================================
    # MPAS geometry namelist for the 30 km mesh
    #===========================================================================
