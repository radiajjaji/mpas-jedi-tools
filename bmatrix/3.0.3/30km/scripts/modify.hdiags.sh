...
#===============================================================================
# Merge and optionally tune 30 km MPAS-JEDI HDIAGS products.
#
# Input:
#   HDIAGS/vargroup1/
#     mpas.cor_rh.nc
...
main()
{
    ...
    VERSION="3.0.3"
    ROOT="${HOME}/jedi/mpas_only/${VERSION}/30km"
    BASE="${ROOT}/HDIAGS"
    ...
    EXPECTED_GRID=655362
    EXPECTED_LEVELS=56

    if [[ "${ROOT}" != \
        "/scratch/lus/arw/jedi/mpas_only/3.0.3/30km" ]]
    then
...
PY
    ...
    log "============================================================"
    log "30 km HDIAGS merge configuration"
    log "============================================================"
    log "Root                       : ${ROOT}"
...
PY
    ...
    log "============================================================"
    log "Merged 30 km HDIAGS products"
    log "============================================================"
